...
The AWS IoT MQTT test client successfully subscribes to the topic (e.g., `Home1/Room1/Lightbulb`) to verify uninterrupted, decrypted message delivery in the cloud. Live telemetry streaming is confirmed in real-time within the AWS console.
